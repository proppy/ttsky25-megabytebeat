...
fn untitleddroid(t: u32, a: u4, b: u4, c: u4, d: u4) -> u8 {
    let cond0 = t>>(a as u32)&(b as u32);
    let p0 = t>>(c as u32);
    let p1 = ((!t)+u32:1)>>(d as u32);
    let s =  if cond0 != u32:0 { p0 } else { p1 };
    s as u8
}
...
#[test_proc]
proc bytebeat_untitleddroid_test {
  ...
  config(t: chan<bool> out) {
    ...
    spawn bytebeat_untitleddroid(a_r, b_r, c_r, d_r, output_s);
