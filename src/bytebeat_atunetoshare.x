...
fn atunetoshare(t: u32, a: u4, b: u4, c: u4, d: u4) -> u8 {
   let cd = (d++c) as u32;
   let s = t*(t>>(a as u32)|t>>(b as u32))&cd;
   s as u8
}
...
#[test_proc]
proc bytebeat_atunetoshare_test {
  ...
  config(t: chan<bool> out) {
    ...
    spawn bytebeat_atunetoshare(a_r, b_r, c_r, d_r, output_s);
